...
export default function SlideItem({ slider, currentSlide }) {
	return (
		<section
			className="bg-[#1a1a1a] text-white rounded-2xl p-8 md:p-12 border border-cyan-300/10 hover:border-cyan-300/30 w-full h-full"
